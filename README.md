![alt text](https://i.imgur.com/33KrByE.jpg)
 ...
 * "I found this restaurant with a web search and I would like to know more about it";
 * "I would like to easily reserve a table";
 * "I would like to find a place to have a Wine Tasting";
 * "I am looking for an Italian Restaurant and I would like to see their menu".
 ...
 * <i>I found this restaurant with a web search and I would like to know more about it.</i>
    ...
    * The navigation bar contains a direct link to the Gallery page, to show the look of the restaurant. The hero images of the website are actual pictures from the location, the idea is to let the user explore the restaurant through a virtual window, and get even more familiar with the place.
 * <i>I would like to easily reserve a table.</i>
 ...
 * <i>I would like to find a place to have a Wine Tasting.</i>
 ...
 * <i>I am looking for an Italian Restaurant and I would like to see their menu.</i>
    * In any page of the webiste, the navbar shows the Menu section, easy to find and use.
    * The Menu section contains links to the full menus, updated to the current day;
    * The restaurant offers a special dinner event with only Italian family traditional recepies (called "Cucina Povera") and the user can read the full menu from the Menu section.
...
- My Code Institute Mentor [Adegbenga Adeye](https://github.com/deye9) for his great advices and inspiration.
- The Code Institute's Slack Channels and the supporting material the tutors provide to build a great project. 
- My friends [Sebastian](https://github.com/SebastianN97) and [Yannick](https://github.com/Yann-McRissos) for the programming tips and support.
